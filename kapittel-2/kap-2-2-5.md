...
På søket `".*spiritualitet.*" %c \ <>` gir Norsk aviskorpus i Corpuscle får vi totalt 163 kollokasjoner fordelt på ?? {@TODO: sett inn tall} tilfeller.

{@TODO: Sett inn tabell fra Corpuscle}
